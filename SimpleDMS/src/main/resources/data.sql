...
INSERT INTO TB_KOREAFOOD
VALUES (SQ_KOREAFOOD.nextval,'비빔밥','hong@naver.com','010-1234-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_KOREAFOOD
VALUES (SQ_KOREAFOOD.nextval,'짜장면','jang@naver.com','010-1230-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_KOREAFOOD
VALUES (SQ_KOREAFOOD.nextval,'청국장','lim@naver.com','010-1235-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_KOREAFOOD
VALUES (SQ_KOREAFOOD.nextval,'김치찌개','Gean@naver.com','010-1236-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_KOREAFOOD
VALUES (SQ_KOREAFOOD.nextval,'부대찌개','Ma@naver.com','010-1237-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_KOREAFOOD
VALUES (SQ_KOREAFOOD.nextval,'돼지국밥','Ah@naver.com','010-1238-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);


INSERT INTO TB_CHINESEFOOD
VALUES (SQ_CHINESEFOOD.nextval,'동파육','hong@naver.com','010-1234-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_CHINESEFOOD
VALUES (SQ_CHINESEFOOD.nextval,'멘보샤','jang@naver.com','010-1230-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_CHINESEFOOD
VALUES (SQ_CHINESEFOOD.nextval,'베이징덕','lim@naver.com','010-1235-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_CHINESEFOOD
VALUES (SQ_CHINESEFOOD.nextval,'만터우','Gean@naver.com','010-1236-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_CHINESEFOOD
VALUES (SQ_CHINESEFOOD.nextval,'고추잡채','Ma@naver.com','010-1237-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_CHINESEFOOD
VALUES (SQ_CHINESEFOOD.nextval,'해삼주스','Ah@naver.com','010-1238-5678','N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
