...
DROP SEQUENCE SQ_KOREAFOOD;
CREATE SEQUENCE SQ_KOREAFOOD START WITH 1 INCREMENT BY 1;

DROP SEQUENCE SQ_CHINESEFOOD;
CREATE SEQUENCE SQ_CHINESEFOOD START WITH 1 INCREMENT BY 1;
...
DROP TABLE TB_KOREAFOOD CASCADE CONSTRAINT;
DROP TABLE TB_CHINESEFOOD CASCADE CONSTRAINT;
...
-- KoreaFood Table Create SQL
CREATE TABLE TB_KOREAFOOD
(
...
-- ChineseFood Table Create SQL
CREATE TABLE TB_CHINESEFOOD
(
